...
const NotificationSchema = new mongoose_1.Schema({
    ...
    taskId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Task", default: null, index: true },
    read: { type: Boolean, default: false },
}, { timestamps: { createdAt: true, updatedAt: false } });
// Keep email delivery aligned with in-app notifications across the app.
NotificationSchema.post("save", function (doc) {
    (0, notifyEmail_1.queueNotifyUserByEmail)(doc.user, doc.title, doc.message, doc.taskId?.toString());
});
