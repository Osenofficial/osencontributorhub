...
exports.getEmailAppName = getEmailAppName;
exports.getSiteUrl = getSiteUrl;
exports.resolveDashboardPath = resolveDashboardPath;
exports.buildNotificationEmail = buildNotificationEmail;
function getEmailAppName() {
    return (process.env.EMAIL_APP_NAME?.trim() ||
