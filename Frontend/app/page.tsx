...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    description:
      'Complete tasks to earn points. Payout by monthly tier (10+ pts to qualify, up to ₹5000/month).',
...
export default function LandingPage() {
  ...
  const dashboardHref = currentUser ? '/dashboard' : '/login'
    ...
    <div className="min-h-screen">
      ...
      <section className="relative grid-bg pt-28 pb-20 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center">
          ...
          <h1 className="mb-5 text-5xl font-bold leading-tight tracking-tight text-balance md:text-7xl">
            <span>OSEN</span> <span className="text-foreground">Contributor Hub</span>
          </h1>

          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground leading-relaxed text-pretty">
            A platform for managing contributions, tasks, and rewards inside the OSEN community. Manage Tasks.
            Empower Contributors. Build Together.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {HOW_IT_WORKS.map((step) => (
              <div key={step.title} className={cn('glass rounded-2xl border p-6', step.border)}>
                <div
                  className={cn(
                    'mb-4 flex size-12 items-center justify-center rounded-xl border bg-background/50',
                    step.border,
                  )}
                >
                ...
                <div className="mb-1 text-xs font-mono text-muted-foreground">
                  Step 0{HOW_IT_WORKS.indexOf(step) + 1}
                </div>
