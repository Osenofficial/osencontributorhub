...
import { LayoutDashboard, ClipboardList, Trophy, User, Bell, Shield } from 'lucide-react'
...
export function MobileNav() {
  ...
  const unread = getNotificationsByUser(currentUser.id).filter((n) => !n.read).length
